...
states["play"] = function()
{
	...
	if (score < 10){player.color = "blue";}
	if (score >= 10 && score < 20){player.color = "green";}
	if (score >= 20 && score < 30){player.color = "yellow";}
	if (score >= 30 && score < 40){player.color = "orange";}
	if (score >= 40 && score <= 50){player.color = "red";}
